...
class NotificationService {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      developer.log(
        '✅ Time zones initialized for $timeZoneName',
        name: 'NotificationService',
      );

      if (!Hive.isBoxOpen('notification_settings')) {
        developer.log(
          'Opening notification_settings box...',
          name: 'NotificationService',
        );
        _settingsBox = await Hive.openBox('notification_settings');
      } else {
        developer.log(
          'notification_settings box already open',
          name: 'NotificationService',
        );
      ...
      developer.log(
        '✅ NotificationService.init() completed successfully',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error in NotificationService.init()',
        name: 'NotificationService',
        error: e,
  ...
  Future<void> _requestPermissions() async {
    ...
    try {
      ...
      final androidResult = await androidPlugin
          ?.requestNotificationsPermission();
      developer.log(
        'Android notification permission result: $androidResult',
        name: 'NotificationService',
      );

      if (androidResult == false) {
        developer.log(
          '⚠️ WARNING: Android notification permission was DENIED!',
          name: 'NotificationService',
        );
      }
      ...
      developer.log(
        'Can schedule exact alarms: $canScheduleExactAlarms',
        name: 'NotificationService',
      );
      ...
      if (canScheduleExactAlarms == false) {
        ...
        developer.log(
          'Exact alarm permission result: $exactResult',
          name: 'NotificationService',
        );
        if (exactResult == false) {
          developer.log(
            '⚠️ WARNING: Exact alarm permission was DENIED!',
            name: 'NotificationService',
          );
        }
      }
      ...
      developer.log(
        'iOS permission result: $iosResult',
        name: 'NotificationService',
      );

      if (iosResult == false) {
        developer.log(
          '⚠️ WARNING: iOS notification permissions were DENIED!',
          name: 'NotificationService',
        );
      }
    } catch (e, stackTrace) {
  ...
  void _onNotificationTapped(NotificationResponse response) {
    developer.log(
      'Notification response: payload=${response.payload}, action=${response.actionId}, type=${response.notificationResponseType}',
      name: 'NotificationService',
    );
    ...
    if (response.actionId == 'stop_azan') {
      developer.log(
        '⏹️ Stop azan action received in foreground',
        name: 'NotificationService',
      );
    ...
    if (response.payload != null && response.payload!.startsWith('azan_')) {
      developer.log(
        '⏹️ Azan notification body tapped, stopping',
        name: 'NotificationService',
      );
  ...
  bool get morningAzkarEnabled {
    try {
      ...
      developer.log(
        '❌ Error getting morningAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  bool get eveningAzkarEnabled {
    try {
      ...
      developer.log(
        '❌ Error getting eveningAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  bool get sleepAzkarEnabled {
    try {
      ...
      developer.log(
        '❌ Error getting sleepAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  bool get prayerTimesEnabled {
    try {
      ...
      developer.log(
        '❌ Error getting prayerTimesEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  bool get azkarReminderEnabled {
    try {
      ...
      developer.log(
        'azkarReminderEnabled: $value',
        name: 'NotificationService',
      );
      return value;
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error getting azkarReminderEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> setMorningAzkarEnabled(bool enabled) async {
    developer.log(
      'Setting morningAzkarEnabled to: $enabled',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error setting morningAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> setEveningAzkarEnabled(bool enabled) async {
    developer.log(
      'Setting eveningAzkarEnabled to: $enabled',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error setting eveningAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> setSleepAzkarEnabled(bool enabled) async {
    developer.log(
      'Setting sleepAzkarEnabled to: $enabled',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error setting sleepAzkarEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> setPrayerTimesEnabled(bool enabled) async {
    developer.log(
      'Setting prayerTimesEnabled to: $enabled',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error setting prayerTimesEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> setAzkarReminderEnabled(bool enabled) async {
    developer.log(
      'Setting azkarReminderEnabled to: $enabled',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error setting azkarReminderEnabled',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> scheduleMorningAzkar() async {
    developer.log(
      '📌 Scheduling morning azkar notification...',
      name: 'NotificationService',
    );
    if (!morningAzkarEnabled) {
      developer.log(
        '⏭️ Morning azkar disabled, skipping',
        name: 'NotificationService',
      );
      return false;
    }
    ...
    try {
      ...
      developer.log(
        '🎯 Target time for morning azkar: $scheduledTime',
        name: 'NotificationService',
      );
      developer.log(
        '⏱️ Time until notification: ${scheduledTime.difference(tz.TZDateTime.now(tz.local)).inMinutes} minutes',
        name: 'NotificationService',
      );
      ...
      developer.log(
        '📤 zonedSchedule() call succeeded for ID 1001',
        name: 'NotificationService',
      );
      ...
      if (isScheduled) {
        developer.log(
          '✅✅ SUCCESS: Morning azkar ID 1001 confirmed in pending list',
          name: 'NotificationService',
        );
      } else {
        developer.log(
          '⚠️ WARNING: Morning azkar ID 1001 NOT found in pending list despite successful zonedSchedule()',
          name: 'NotificationService',
        );
        developer.log(
          '💡 This might be normal with matchDateTimeComponents - notification will trigger at scheduled time',
          name: 'NotificationService',
        );
      }
      ...
      developer.log(
        '❌ FAILED: Error scheduling morning azkar',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> scheduleEveningAzkar() async {
    developer.log(
      'Scheduling evening azkar notification...',
      name: 'NotificationService',
    );
    if (!eveningAzkarEnabled) {
      developer.log(
        'Evening azkar disabled, skipping',
        name: 'NotificationService',
      );
      return false;
    }
    ...
    try {
      ...
      if (isScheduled) {
        developer.log(
          '✅ Evening azkar notification scheduled',
          name: 'NotificationService',
        );
      } else {
        developer.log(
          '⚠️ Evening azkar notification not found in pending list',
          name: 'NotificationService',
        );
      }
      return isScheduled;
      ...
      developer.log(
        '❌ Error scheduling evening azkar',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> scheduleSleepAzkar() async {
    developer.log(
      'Scheduling sleep azkar notification...',
      name: 'NotificationService',
    );
    if (!sleepAzkarEnabled) {
      developer.log(
        'Sleep azkar disabled, skipping',
        name: 'NotificationService',
      );
      return false;
    }
    ...
    try {
      ...
      if (isScheduled) {
        developer.log(
          '✅ Sleep azkar notification scheduled',
          name: 'NotificationService',
        );
      } else {
        developer.log(
          '⚠️ Sleep azkar notification not found in pending list',
          name: 'NotificationService',
        );
      }
      return isScheduled;
  ...
  Future<bool> scheduleAzkarReminders() async {
    ...
    if (!azkarReminderEnabled) {
      developer.log(
        'Azkar reminders disabled, skipping',
        name: 'NotificationService',
      );
      return false;
    }
    ...
    try {
      ...
      final reminderCount = pending
          .where((n) => n.id >= 2000 && n.id < 2060)
          .length;

      developer.log(
        '✅ Azkar reminders scheduled: $scheduledCount notifications, $reminderCount verified in pending',
        name: 'NotificationService',
      );
      return reminderCount > 0;
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error scheduling azkar reminders',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> schedulePrayerTimes() async {
    developer.log(
      'Scheduling prayer times notifications...',
      name: 'NotificationService',
    );
    if (!prayerTimesEnabled) {
      developer.log(
        'Prayer times disabled, skipping',
        name: 'NotificationService',
      );
      return false;
    }
    ...
    try {
      ...
      for (final prayer in prayers) {
        developer.log(
          'Scheduling notification for ${prayer['name']}',
          name: 'NotificationService',
        );
      ...
      await Future.delayed(const Duration(milliseconds: 500));
      final pending = await getPendingNotifications();
      final prayerCount = pending
          .where((n) => n.id >= 3001 && n.id <= 3005)
          .length;
      final reminderCount = pending
          .where((n) => n.id >= 3101 && n.id <= 3105)
          .length;

      developer.log(
        '✅ Prayer times notifications scheduled: $prayerCount prayers, $reminderCount reminders verified',
        name: 'NotificationService',
      );
      return prayerCount > 0;
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error scheduling prayer times',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> cancelMorningAzkar() async {
    developer.log(
      'Canceling morning azkar notification (ID: 1001)',
      name: 'NotificationService',
    );
    try {
      await _notifications.cancel(1001);
      developer.log(
        '✅ Morning azkar notification canceled',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error canceling morning azkar',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> cancelEveningAzkar() async {
    developer.log(
      'Canceling evening azkar notification (ID: 1002)',
      name: 'NotificationService',
    );
    try {
      await _notifications.cancel(1002);
      developer.log(
        '✅ Evening azkar notification canceled',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error canceling evening azkar',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> cancelSleepAzkar() async {
    developer.log(
      'Canceling sleep azkar notification (ID: 1003)',
      name: 'NotificationService',
    );
    try {
      await _notifications.cancel(1003);
      developer.log(
        '✅ Sleep azkar notification canceled',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error canceling sleep azkar',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> cancelAzkarReminders() async {
    developer.log(
      'Canceling all azkar reminders (IDs: 2000-2059)',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '❌ Error canceling azkar reminders',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> cancelPrayerTimes() async {
    developer.log(
      'Canceling all prayer times notifications',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        '✅ Prayer times notifications canceled',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error canceling prayer times',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  tz.TZDateTime _nextTime(int hour, int minute) {
    ...
    developer.log(
      '_nextTime: now=$now, target=$scheduledDate',
      name: 'NotificationService',
    );

    if (scheduledDate.isBefore(now)) {
      developer.log(
        '_nextTime: target is in the past, adding 1 day',
        name: 'NotificationService',
      );
    ...
    developer.log(
      '_nextTime($hour:$minute) -> final=$scheduledDate (${scheduledDate.difference(now).inMinutes} min from now)',
      name: 'NotificationService',
    );
  ...
  Future<void> showTestNotification({BuildContext? context}) async {
    ...
    try {
      await _notifications.show(
        0,
        'اختبار الإشعارات',
        'هذا إشعار اختباري من تطبيق بصائر',
      ...
      if (context != null) {
        NotificationOverlayManager.show(
          ...
          body: 'هذا إشعار اختباري من تطبيق بصائر',
  ...
  Future<void> showAdminSystemNotification({
    required String title,
    required String body,
  }) async {
    developer.log(
      'Showing admin system notification...',
      name: 'NotificationService',
    );
    final id = 6000 + (DateTime.now().millisecondsSinceEpoch % 100000);
    ...
    try {
      ...
      developer.log(
        '✅ Admin system notification shown',
        name: 'NotificationService',
      );
    } catch (e, stackTrace) {
      developer.log(
        '❌ Error showing admin system notification',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  void showPrayerOverlay(BuildContext context, String prayerName) {
    NotificationOverlayManager.showPrayerNotification(
      context,
  ...
  Future<List<PendingNotificationRequest>> getPendingNotifications() async {
    developer.log(
      '🔍 Fetching all pending notifications...',
      name: 'NotificationService',
    );
    try {
      ...
      final azkarCount = pending
          .where((n) => n.id >= 1000 && n.id < 2000)
          .length;
      final reminderCount = pending
          .where((n) => n.id >= 2000 && n.id < 3000)
          .length;
      final prayerCount = pending
      ...
      developer.log(
        '📈 Summary: Total=$pendingCount, Azkar=$azkarCount, Reminders=$reminderCount, Prayer=$prayerCount',
        name: 'NotificationService',
      );
  ...
  Future<void> checkPermissionsStatus() async {
    developer.log(
      '=== Checking Notification Permissions Status ===',
      name: 'NotificationService',
    );
    try {
      final androidPlugin = _notifications
  ...
  Future<bool> scheduleSimpleTestNotification() async {
    developer.log(
      '📌 Scheduling SIMPLE test notification (no matchDateTimeComponents)...',
      name: 'NotificationService',
    );
    try {
      // Cancel existing
      ...
      developer.log(
        '🎯 Scheduling for: $scheduledTime (in ${scheduledTime.difference(now).inSeconds} seconds)',
        name: 'NotificationService',
      );
      ...
      developer.log(
        '📤 zonedSchedule() call succeeded for simple test (ID 9998)',
        name: 'NotificationService',
      );
      ...
      if (isFound) {
        developer.log(
          '✅ SUCCESS: Simple test notification ID 9998 found in pending list!',
          name: 'NotificationService',
        );
      } else {
        developer.log(
          '❌ FAILED: Simple test notification ID 9998 NOT found in pending list!',
          name: 'NotificationService',
        );
      }
      ...
      developer.log(
        '❌ Error scheduling simple test notification',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> scheduleTestNotificationIn30Seconds() async {
    developer.log(
      '📋 Scheduling test notification in 30 seconds...',
      name: 'NotificationService',
    );
    try {
      ...
      developer.log(
        'Cancelled existing notification with ID 9999',
        name: 'NotificationService',
      );
      ...
      developer.log(
        'Target notification time: $scheduledTime',
        name: 'NotificationService',
      );
      developer.log(
      ...
      developer.log(
        '📤 Calling zonedSchedule with ID 9999...',
        name: 'NotificationService',
      );
      ...
      developer.log(
        '✅ zonedSchedule() completed without error',
        name: 'NotificationService',
      );
      ...
      if (isScheduled) {
        developer.log(
          '✅ Notification ID 9999 FOUND in pending list',
          name: 'NotificationService',
        );
        final notif = pending.firstWhere((n) => n.id == 9999);
        developer.log(
          'Notification details: ID=${notif.id}, Title=${notif.title}',
          name: 'NotificationService',
        );
      } else {
        developer.log(
          '❌ Notification ID 9999 NOT FOUND in pending list',
          name: 'NotificationService',
        );
        developer.log(
          'All pending notification IDs: ${pending.map((n) => n.id).toList()}',
          name: 'NotificationService',
        );
      }
      ...
      developer.log(
        '❌ ERROR in scheduleTestNotificationIn30Seconds',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<Map<String, bool>> checkNotificationPermissions() async {
    ...
    try {
      ...
      if (notificationsEnabled != true) {
        developer.log(
          '⚠️ WARNING: Notifications are disabled!',
          name: 'NotificationService',
        );
      }
      if (canScheduleExact != true) {
        developer.log(
          '⚠️ WARNING: Cannot schedule exact alarms!',
          name: 'NotificationService',
        );
      }
  ...
  Future<bool> openExactAlarmSettings() async {
    try {
      ...
      final alreadyGranted = await androidPlugin
          .canScheduleExactNotifications();
      ...
      developer.log(
        '❌ Error opening exact alarm settings',
        name: 'NotificationService',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<bool> _scheduleZoned({
    ...
    try {
      ...
      developer.log(
        '✅ Scheduled id=$id with mode=$mode',
        name: 'NotificationService',
      );
      return true;
    } catch (e, st) {
      developer.log(
        '❌ zonedSchedule failed for id=$id mode=$mode: $e',
        name: 'NotificationService',
        error: e,
        stackTrace: st,
      );
      ...
      final isPermError =
          e.toString().toLowerCase().contains('exact_alarm') ||
      ...
      if (mode == AndroidScheduleMode.exactAllowWhileIdle && isPermError) {
        try {
          developer.log(
            '🔁 Retrying id=$id with inexactAllowWhileIdle…',
            name: 'NotificationService',
          );
          await doSchedule(AndroidScheduleMode.inexactAllowWhileIdle);
          developer.log(
            '✅ Scheduled id=$id with fallback inexact mode',
            name: 'NotificationService',
          );
          return true;
        } catch (e2, st2) {
          developer.log(
            '❌ Fallback also failed for id=$id: $e2',
            name: 'NotificationService',
            error: e2,
            stackTrace: st2,
          );
  ...
  Future<void> initializeAllSchedules() async {
    developer.log(
      'Initializing all notification schedules...',
      name: 'NotificationService',
    );
    try {
