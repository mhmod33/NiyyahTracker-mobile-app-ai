  ...
  Future<void> _loadMonthStats() async {
    ...
    try {
      ...
      final futures = await Future.wait([
        _firebaseService.getMonthlyWorships(
          userId,
          _selectedDate.year,
          _selectedDate.month,
        ),
      ...
      final goals = allGoals.where((goal) {
        return goal.startDate.year == _selectedDate.year &&
            goal.startDate.month == _selectedDate.month;
      }).toList();
      ...
      setState(() {
        ...
        _goalsCompletionRate = goals.isNotEmpty
            ? (_completedGoals / goals.length) * 100
            : 0.0;
  ...
  Future<void> _generatePdf(
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  'Basair',
                  style: pw.TextStyle(fontSize: 40, color: PdfColors.green900),
                ),
                pw.SizedBox(height: 10),
                pw.Text(
                  'Monthly Worship Report',
                  style: pw.TextStyle(fontSize: 24, color: PdfColors.green700),
                ),
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      _pdfStatRowEnglish(
                        ...
                        '${_goalsCompletionRate.toStringAsFixed(1)}%',
                        font,
                      ),
                      pw.SizedBox(height: 10),
                      _pdfStatRowEnglish(
    ...
    try {
      await Printing.layoutPdf(
        ...
        name: 'Basair_Report_${_selectedDate.month}_${_selectedDate.year}.pdf',
      );
    } catch (e) {
  ...
  Widget _previewCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.darkGreen.withOpacity(isDark ? 0.2 : 0.3),
            blurRadius: 20,
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                _statRow(
                  ...
                  'الأهداف المكتملة',
                  '$_completedGoals/${_monthlyGoals.length}',
                ),
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 8),
                  child: Divider(color: Colors.white12, height: 1),
          ...
          Center(
            child: Container(
              ...
              child: Text(
                '"رحلتك الروحية هذا الشهر مميزة يا ${userName?.split(' ').first} — استمر 🤍"',
                style: GoogleFonts.ibmPlexSansArabic(
                  color: AppColors.goldLight,
                  fontSize: 13,
  ...
  Widget _analyticsInsights(bool isDark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark ? Colors.white.withOpacity(0.06) : AppColors.paleGreen,
        ),
        boxShadow: [
          if (!isDark)
            BoxShadow(
